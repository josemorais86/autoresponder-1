	...
	var p = TextExtTags.prototype,
		...
		DEFAULT_OPTS = {
			...
			html : {
				...
				tag  : '<div class="text-tag"><div class="text-button"><div class="icono"><span class="glyphicon glyphicon-user"></span></div><span class="text-label"/><a class="text-remove"/></div></div>'
			}
		}
		;
