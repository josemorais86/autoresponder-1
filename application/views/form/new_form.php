  ...
  <div class="panel-body">
    <p> Si quieres añadir campos a tu formulario debes arrastrar los elementos de la caja <strong>"campos"</strong>a la caja <strong>"formulario"</strong>.</p>
          ...
          <div class="formulario well" >
            <div>
              <span style="font-size: 22px; color: #2B99D3;font-family: Arial,Helvetica,sans-serif" <strong><div id="titulo_form">Formulario</div></strong></span> </div>
                <ul id="sortable1" class="sortable1">
                  <li id='1' class='ui-state-default' style='width: 173px; border: none; background: none;cursor: move;'>
                    <p class='label-r'>NOMBRE:</p>
                    <input type='text' class='input-r' disabled>
                  </li>
                  <li id='2' class='ui-state-default ui-state-disabled' style='width: 173px; border: none; background: none; opacity:0.65;'>
                    <p class='label-r'>EMAIL</p>
                    <input type='text' class='input-r' disabled>
                  </li>
                </ul>  
          <button disabled class="btn btn-primary"  name="Button_Update" data-fancybox-type='iframe' style="color: rgb(255,255,255);padding: 6px 13px; opacity:1;"><span style="font-size:20px"><div id="boton_form">Suscríbete!</div></span></button>    
        </div>
       ...
       <div><span style="font-size: 32px; color: #2B99D3;font-family: Arial,Helvetica,sans-serif">Campos</span></div>
        ...
        <table class="table table-bordered" style="width:440px">
          <tbody>
              <?php 
                $hidden = array('id_lista' => $id_lista);
                echo form_open('forms/crear_form', '', $hidden);
                echo form_input(array('name' => 'campos', 'type'=>'hidden', 'id' =>'campos', 'value' =>'1,2'));
              ?> 
              <tr>
