...
<div style="display: none; top:-15px" id="dialog_new_boletin" title="Nuevo Boletín">
				...
				<table class="table table-bordered table-hover new_seguimiento">
					<tbody>
						<tr>
							...
							<td>
								<input id="nombre"  maxlength="210" size="80" type="text" name="nombre" style="height: 30">
							</td>
						</tr>
						<tr>
							<th style="font-weight: bold; font-style: italic; font-size: 13px;">
							...
							<td>
								<input id="rte"  maxlength="210" size="80" type="text" name="rte" style="height: 30" >
							</td>
						</tr>
						<tr>	
							<th style="font-weight: bold; font-style: italic; font-size: 13px;">
				    	...
				    	<td>
				    		<div style="margin-top:10px;margin-bottom:15px">
				    			<div style="margin-left:10px;float:left">
				    				<input id="fecha" name="fecha" size="10" type="text" style="width: 100px" />
								</div>
